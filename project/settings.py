...
EMAIL_HOST_USER = 'dax.stracke8@ethereal.email'
EMAIL_HOST_PASSWORD = '4kYWyGw58rkxkz63PF'
EMAIL_PORT = '587'
EMAIL_USE_TLS = True

LOGIN_REDIRECT_URL = '/profile/' # Чтобы после авторизации перенаправлялось на страницу пользователя

SOCIAL_AUTH_GITHUB_KEY = '3962061c82a1f803b8be'
SOCIAL_AUTH_GITHUB_SECRET = 'ca299287ee05acb090f4d760c7b1a295fda04040'
